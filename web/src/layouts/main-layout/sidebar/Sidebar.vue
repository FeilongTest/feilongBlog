      ...
      >
        <li class="nav-item">
          ...
          >
            <span class="svg-icon">
              <inline-svg
                :src="getAssetPath('/media/icons/duotune/abstract/abs038.svg')"
              />
            </span>
          </a>
        </li>
        ...
        <li class="nav-item">
          ...
          >
            <span class="svg-icon">
              <inline-svg
                :src="getAssetPath('/media/icons/duotune/abstract/abs036.svg')"
              />
            </span>
          </a>
        </li>
        ...
        <li class="nav-item">
          ...
          >
            <span class="svg-icon">
              <inline-svg
                :src="getAssetPath('/media/icons/duotune/abstract/abs026.svg')"
              />
            </span>
          </a>
        </li>
